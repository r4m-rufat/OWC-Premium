...
public class Settings extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        preferenceManager = new PreferenceManager(Settings.this);
    ...
    private void changeLanguageSpinner(){
        ...
        if (preferenceManager.getString("language_whole").equals("Azerbaijani")){
        ...
        if (preferenceManager.getBoolean("dark_mode")){
            ...
            ArrayAdapter<String> adapter = new ArrayAdapter<String>(context, R.layout.layout_for_spinner_color_for_settings, languagesList);
            adapter.setDropDownViewResource(R.layout.layout_dropdown_spinner_for_settings);
