package com.kivitool.owcpremium.Home;
...
import com.kivitool.owcpremium.AdapTers.HourlyAdapter;
import com.kivitool.owcpremium.AdapTers.WeeklyAdapter;
import com.kivitool.owcpremium.AdapTers.WindAdapter;
...
import com.kivitool.owcpremium.Models.Weekly.DailyItem;
...
import com.kivitool.owcpremium.Services.NotificationService;
...
import static com.kivitool.owcpremium.DrawerLayoutItems.MyLocation.REQUEST_CODE;
...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    private void reloadPageWithFast() {
        ...
        if (preferenceManager.getString("current_pressure") != null) {
            ...
            setupBackgrounds.setupBackgrounds(preferenceManager, preferenceManager.getString("current_icon"), backgroundGif, drawerLayout, context);
    ...
    private void setTextToNavigationViewItems() {
        ...
        MenuItem backgrounds = menu.findItem(R.id.backgrounds);
        ...
        backgrounds.setTitle(getString(R.string.backgrounds));
