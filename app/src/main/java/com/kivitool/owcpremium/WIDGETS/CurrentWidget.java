package com.kivitool.owcpremium.WIDGETS;
...
import com.kivitool.owcpremium.InitialActivities.SplashActivity;
...
public class CurrentWidget extends AppWidgetProvider {
    ...
    private void updateAppWidget(Context context, AppWidgetManager appWidgetManager,
        ...
        if (work){
            ...
            remoteViews.setTextViewText(R.id.txt_wind_speed, context.getString(R.string.wind_speed) + ": " + preferenceManager.getInteger("widget_wind_speed") + " " + context.getString(R.string.m_sec));
